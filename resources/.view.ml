...
// context.draw_text(4.0, 48.0, "default", "damn this works?", 36.0, Color { red: 101, green: 235, blue: 134 });
// context.draw_image(0.0, 0.0, metadata.window_width, metadata.window_height, "./resources/textures/wood.png", ObjectFit::Cover);
